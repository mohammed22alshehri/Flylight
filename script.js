// ===== Configuration =====
const ADMIN_PASSWORD = 'PLACEHOLDER_ADMIN_PASSWORD'; // Will be replaced by GitHub Actions
...
function adminLogin() {
  ...
  // Check if password was replaced (security check)
  if (ADMIN_PASSWORD.includes('PLACEHOLDER_ADMIN_PASSWORD')) {
    errorEl.style.display = 'block';
    errorEl.textContent = '⚠️ لم يتم تكوين كلمة المرور';
